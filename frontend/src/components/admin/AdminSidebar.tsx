...
import { LayoutDashboard, Settings, UserCheck, Code2, FolderKanban, BookOpen, Image as ImageIcon, LogOut, Globe, Mail, Bot, Link as LinkIcon } from 'lucide-react';
...
export const AdminSidebar = () => {
  ...
  const navItems = [
    ...
    { label: 'Özel İletişim Butonları', href: '/admin/contact-sections', icon: LinkIcon },
