  ...
  return (
    <div className="space-y-6 max-w-6xl mx-auto">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pb-4 border-b border-gray-800">
        <div>
          <h1 className="text-2xl font-bold font-heading tracking-wider">PROJELER YÖNETİMİ</h1>
          <p className="text-xs text-gray-400 mt-1">Öne çıkan projeleriniz, teknoloji detayları ve linkler</p>
        </div>
