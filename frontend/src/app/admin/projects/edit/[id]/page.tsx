      ...
      try {
        ...
        if (proj) {
          setFormData({
            ...
            title_tr: proj.title_tr || '',
            title_en: proj.title_en || '',
            title_de: proj.title_de || '',
            title_ru: proj.title_ru || '',
            element_tr: proj.element_tr || '',
            element_en: proj.element_en || '',
            element_de: proj.element_de || '',
            element_ru: proj.element_ru || '',
            innovation_tr: proj.innovation_tr || '',
            innovation_en: proj.innovation_en || '',
            innovation_de: proj.innovation_de || '',
            innovation_ru: proj.innovation_ru || '',
            tech_stack: proj.tech_stack || '',
            button_url: proj.button_url || '',
            demo_url: proj.demo_url || '',
            isSignature: proj.isSignature ?? false,
            queue: proj.queue || 0,
      ...
      <form onSubmit={handleSubmit} className="space-y-8 text-xs">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6 shadow-lg space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <div>
              <label className="block text-gray-400 mb-1 font-semibold uppercase">GitHub/İncele URL</label>
              <input
                type="text"
            ...
            <div>
              <label className="block text-gray-400 mb-1 font-semibold uppercase">Canlı Demo URL</label>
              <input
                type="text"
          ...
          <div className="space-y-6">
            <div>
              <label className="block text-gray-400 mb-1 font-semibold uppercase">
                Proje Başlığı ({activeLangTab.toUpperCase()})
              </label>
              <input
                type="text"
                required
            ...
            <div>
              <div className="flex items-center justify-between mb-1">
                ...
                >
                  <Code size={12} /> Paragraf Sonu Ekle
                </button>
              </div>
              <textarea
                rows={6}
